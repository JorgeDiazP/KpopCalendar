...
import com.jorgediazp.kpopcalendar.calendar.presentation.component.ThumbnailView
import com.jorgediazp.kpopcalendar.calendar.presentation.component.YoutubeVideoPlayer
...
fun SongCard(
    ...
    Card(
        ...
        ), shape = RoundedCornerShape(24.dp), border = BorderStroke(2.dp, color)
    ) {
        Column {
            Row(
